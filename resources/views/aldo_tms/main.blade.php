...
<body>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      const photoPreview2 = document.getElementById('photoPreview');
      const captureButton2 = document.getElementById('capture2');
      const saveButton2 = document.getElementById('savePhoto2');

      const video3 = document.getElementById('video3');
      const canvas3 = document.getElementById('canvas3');
      const photoPreview3 = document.getElementById('photoPreview');
      const captureButton3 = document.getElementById('capture3');
      const saveButton3 = document.getElementById('savePhoto3'); // Make sure this button exists for Save Photo in Capture Modal 2
      ...
      navigator.mediaDevices.getUserMedia({
        ...
        .then(stream => {
          ...
          video3.srcObject = stream; // Reuse stream for Capture Modal 2
        })
        .catch(error => {
